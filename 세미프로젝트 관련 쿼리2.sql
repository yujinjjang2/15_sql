...
INSERT INTO NOTICE_BOARD VALUES (SEQ_NOTICE_NO.NEXTVAL, '공지사항 제목 1', '공지사항 내용 1', DEFAULT);
INSERT INTO NOTICE_BOARD VALUES (SEQ_NOTICE_NO.NEXTVAL, '공지사항 제목 2', '공지사항 내용 2', DEFAULT);
INSERT INTO NOTICE_BOARD VALUES (SEQ_NOTICE_NO.NEXTVAL, '공지사항 제목 3', '공지사항 내용 3', DEFAULT);
INSERT INTO NOTICE_BOARD VALUES (SEQ_NOTICE_NO.NEXTVAL, '공지사항 제목 4', '공지사항 내용 4', DEFAULT);
...
-- 이전글 가져오기, 다음글 가져오기 
SELECT 
	A.NOTICE_NO, A.NOTICE_TITLE, A.NOTICE_DETAIL, A.NOTICE_UPLOAD_DATE, A.PRE_NOTICE_NO, A.PRE_NOTICE_TITLE, A.NEXT_NOTICE_NO, A.NEXT_NOTICE_TITLE
FROM 
	(
		SELECT 
			NOTICE_NO, NOTICE_TITLE, NOTICE_DETAIL, TO_CHAR(NOTICE_UPLOAD_DATE, 'YYYY. MM. DD') NOTICE_UPLOAD_DATE
