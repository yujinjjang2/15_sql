...
SELECT 
	D.DEPARTMENT_NAME || '의 정원은 ' ||
	D.CAPACITY || '명 입니다.' "학과별 정원"
FROM 
	TB_DEPARTMENT D;
...
FROM 
	TB_STUDENT S
WHERE 1 = 1
  AND S.STUDENT_NO IN ('A513079', 'A513090', 'A513091', 'A513110', 'A513119')
ORDER BY 1 DESC;
...
WHERE 1 = 1
  AND S.ABSENCE_YN = 'N'
  AND S.STUDENT_ADDRESS LIKE '%전주%'
  AND SUBSTR(TO_CHAR(S.ENTRANCE_DATE, 'YYYYMMDD'), 3, 2) = '02';
