...
-- 궁금한 점 : USER_ID, USER_NO 둘 다 PRIMARY KEY인데, 하나만 NULL 이라면 ? 오류남, 무조건 둘다 값이 있어야 함!
...
--
--INSERT INTO USER_TEST1 VALUES(1, 'USER01', 'PASS01', '980903-1111111', '남', '010-1111-2222', '서울시 서초구', 'Y');
--INSERT INTO USER_TEST1 VALUES(2, 'USER02', 'PASS02', '123456-2111111', '여', '010-2222-2222', '서울시 강동구', 'N');
--INSERT INTO USER_TEST1 VALUES(3, 'USER03', 'PASS03', '578958-1111111', '남', '010-3333-2222', '서울시 중구', 'Y');
--INSERT INTO USER_TEST1 VALUES(4, 'USER04', 'PASS04', '312578-1111111', '남', '010-4444-2222', '서울시 구로구', 'Y');
--INSERT INTO USER_TEST1 VALUES(5, 'USER05', 'PASS05', '134567-2111111', '여', '010-5555-2222', '서울시 강북구', 'Y');
...
CREATE TABLE USER_TEST1(
	...
	CONSTRAINT CK_USET_TEST_STATUS CHECK(STATUS IN('Y', 'N')),
	CONSTRAINT UK_USET_TEST_PNO UNIQUE(PNO)
);

COMMENT ON COLUMN USER_TEST1.USER_NO IS '회원번호';
COMMENT ON COLUMN USER_TEST1.USER_ID IS '회원아이디';
COMMENT ON COLUMN USER_TEST1.USER_PWD IS '비밀번호';
COMMENT ON COLUMN USER_TEST1.PNO IS '주민등록번호';
COMMENT ON COLUMN USER_TEST1.GENDER IS '성별';
COMMENT ON COLUMN USER_TEST1.PHONE IS '연락처';
COMMENT ON COLUMN USER_TEST1.ADDRESS IS '주소';
...
INSERT INTO USER_TEST1
VALUES (2, 'user02', 'pass02', '880122-2234567', '여', '010-2222-9999', '서울시 강남구 삼성동', 'N');

INSERT INTO USER_TEST1
VALUES (3, 'user03', 'pass03', '901222-1234567', '여', '010-3333-9999', '서울시 강남구 대치동', 'Y');

INSERT INTO USER_TEST1
VALUES (4, 'user04', 'pass04', '978564-1234567', '남', '010-4444-9999', '서울시 강남구 청담동', 'N');
